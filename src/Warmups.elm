...
page _ =
    ...
    , div [ class "w-100" ] [ h3 [] [ text "Warmups" ] ]
    , p [] [ text "Estimated Time: 15 minutes" ]
    , text "In order to avoid injury, it is important to warm up. By following this warmup plan, players should find themselves prepared to undergo the drills for the lesson."
    , ol []
