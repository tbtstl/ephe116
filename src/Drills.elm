...
drillRecord name =
    case name of
        ...
        _ ->
            { name = "Not Found", time = "", next = { name = "Go Home", href = "/" }, details = [ "" ] }
